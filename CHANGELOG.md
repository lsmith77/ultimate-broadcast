...
- Nothing is delivered upstream: UltiOrganizer's API is read-only, so a score kept here is parallel to the tournament record. [`docs/UPSTREAM.md`](docs/UPSTREAM.md).

...
- **Sign in on the phone and skip codes entirely.** The code prompt does not appear for an administrator at all, and the "not on the scoreboard" banner offers the switch instead of telling you to go and find yourself.

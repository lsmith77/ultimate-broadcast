...
module.exports = defineConfig({
  ...
  testMatch: ['lineup.spec.js', 'declared.spec.js', 'bios.spec.js', 'timeouts.spec.js', 'provider.spec.js', 'recorded.spec.js', 'scoreclient.spec.js', 'scoresource.spec.js', 'roster.spec.js', 'target.spec.js', 'facts.spec.js', 'playingtime.spec.js', 'scorearchive.spec.js', 'diagnostics.spec.js'],
